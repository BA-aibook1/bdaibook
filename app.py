...
# ==========================================
# 2. MASTER DATABASE ENGINE & AUTO-MIGRATION
# ==========================================
...
def init_master_database():
    ...
    # Safe Auto-Migration Engine (Fixes SQLite Column Errors)
    c.execute("PRAGMA table_info(master_app_table)")
    ...
    c.execute("""
        CREATE TABLE IF NOT EXISTS boost_requests (
            boost_id TEXT PRIMARY KEY, user_id TEXT, post_id TEXT, plan TEXT, amount TEXT, trx_info TEXT, status TEXT DEFAULT 'Pending', created_at TEXT
        );
    """)
    c.execute("""
    ...
    c.execute("""
        CREATE TABLE IF NOT EXISTS likes (
            user_id TEXT, post_id TEXT, category TEXT DEFAULT 'general', PRIMARY KEY (user_id, post_id)
        );
    """)
    c.execute("""
...
# ==========================================
# 3. HELPER & CSS (PERFECT CIRCLE PROFILE PIC)
# ==========================================
...
# Custom Round Image Styling
st.markdown("""
<style>
    .circular-avatar-main {
        width: 110px;
        height: 110px;
        border-radius: 50% !important;
        object-fit: cover !important;
        border: 3px solid #0064e0 !important;
    }
